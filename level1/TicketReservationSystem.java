...
public class TicketReservationSystem {
    ...
    public static void main(String[] args) {
        ...
        // Adding tickets
        system.addTicket(1, "kalpesh", "KGF", "A1", "10:00 AM");
        system.addTicket(2, "kapil", "Bahubali", "B2", "12:00 PM");
        system.addTicket(3, "nishant", "Pushpa", "C3", "02:00 PM");

        // Displaying tickets
        system.displayTickets();

        // Searching for a ticket
        system.searchTicket("kalpesh");
        system.searchTicket("kapil");
